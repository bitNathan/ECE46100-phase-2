...
const url_parse_1 = require("../src/url_parse"); // Adjust the import path as necessary
// 5 test cases
describe('parseURL function tests', () => {
    ...
    it('should return owner and repo name for a valid GitHub URL', async () => {
        ...
        const result = await (0, url_parse_1.parseURL)(url);
...
//# sourceMappingURL=url_parse.test.js.map