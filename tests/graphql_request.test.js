...
describe('graphqlRequest', () => {
    ...
    it('should return data for a successful GraphQL request', async () => {
        ...
        const response = await (0, graphql_request_1.graphqlRequest)(query);
    ...
    it('should reject with errors if the GraphQL request returns errors', async () => {
        ...
        await expect((0, graphql_request_1.graphqlRequest)(query)).rejects.toEqual([{ message: 'Invalid query' }]);
    });
    ...
    it('should reject with an error message if the response is not okay', async () => {
        ...
        await expect((0, graphql_request_1.graphqlRequest)(query)).rejects.toEqual("Error failed to get a response from the API");
    });
    ...
    it('should throw an error for an empty query string', async () => {
        ...
        await expect((0, graphql_request_1.graphqlRequest)(query)).rejects.toEqual([{ message: 'Query cannot be empty' }]);
    });
});
//# sourceMappingURL=graphql_request.test.js.map